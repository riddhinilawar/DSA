...
Example 1:    Input: words = ["abba","baba","bbaa","cd","cd"]                            Output: ["abba","cd"]
...
Example 2:    Input: words = ["a","b","c","d","e"]                                                    Output: ["a","b","c","d","e"]
...
class Solution {
    public List<String> removeAnagrams(String[] strs) {
        ...
        char arrfirst[]=strs[0].toCharArray();
        Arrays.sort(arrfirst);
        String tempfirst= new String(arrfirst);
        res.add(strs[0]);
        String curr=tempfirst;
