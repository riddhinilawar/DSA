...
class Solution
{
    //step 1 function-->to get toposort using dfs
    ...
    //step 3 function-->to get all the components of the graph
    ...
    {
        //step 1-toposort--like to get the last finished
        int[] vis = new int[V];
        ...
        //step 2-toposort--reverse the edges
        ...
        //ste 3--get all the connected components
        int scc = 0;
        while (!st.isEmpty()) {
            int node = st.peek();
            st.pop();
